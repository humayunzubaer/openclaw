...
class ImportAnalysisEngine:
    ...
    OVERSTAY_LEGAL_BASIS = (
        "কাস্টমস আইন ২০২৩ ধারা ১১৯ সহপঠিত ওয়্যারহাউসে পণ্য সংরক্ষণের মেয়াদ নির্ধারণ "
        "বিধিমালা, ২০২৪ [এসআরও ২১১-আইন/২০২৪/৬৩/কাস্টমস] বিধি ৩-৫ — সরাসরি/প্রচ্ছন্ন "
        "রপ্তানিমুখী প্রতিষ্ঠানে সর্বোচ্চ ২৪ মাস 【V】; গণনা-সূচনা: আমদানিতে ছাড়ের তারিখ। "
        "মেয়াদোত্তীর্ণ (বর্ধন-অনুমোদন ব্যতীত) কাঁচামালে শুল্ক-কর পরিশোধযোগ্য।"
    )
    ...
    def _build_overstay(self, result: ImportAnalysisResult):
        ...
        for (hs, _), items in sorted(groups.items(), key=lambda kv: -sum(x[1] for x in kv[1])):
            ...
            remarks = (
                ...
                f"{total_kg:,.3f} কেজি নির্ধারিত সংরক্ষণ-মেয়াদ ({self.overstay_years:g} বছর — "
                f"এসআরও ২১১/২০২৪ বিধি ৩-৫; সরাসরি/প্রচ্ছন্ন রপ্তানিমুখীতে ২৪ মাস 【V】, শ্রেণিভেদে "
                f"২৪/৪৮/১২/৬ মাস; কর্তন-তারিখ {cutoff.strftime('%d.%m.%Y')}) অতিক্রান্ত হইবার পরও "
                f"বন্ডে অবশিষ্ট। শুল্ক-কর পরিশোধযোগ্য। " + BANK_GUARANTEE_NOTE
            )
            if no_tax:
