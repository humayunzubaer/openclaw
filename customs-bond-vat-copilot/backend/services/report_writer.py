...
# Excel-এ বাংলা: Arial-এ বাংলা গ্লিফ নাই, তাই সিস্টেম যাহা খুশি বসায়
# এবং কার্যপত্র কম্পিউটারভেদে ভিন্ন দেখায়। Nikosh ইউনিকোড বাংলা ফন্ট —
# ইহাতে বাংলা ও ইংরেজি দুই-ই ঠিক আসে।
#
# ★ এখানে SutonnyMJ ব্যবহার করা হয় না। উহা ASCII-ভিত্তিক, তাই প্রতিটি
#   ঘরের লেখা রূপান্তর করিতে হইত এবং সূত্র-নির্ভর ঘরগুলি ভাঙিয়া যাইত।
#   বিজয় ফন্টের প্রয়োজন হইলে Word প্রতিবেদন (.docx) ব্যবহার করুন।
FONT_NAME = "Nikosh"
