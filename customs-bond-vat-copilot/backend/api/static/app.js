...
const CLAIM_KEYS = [
  ...
  ["দাবি ৬ — মেয়াদোত্তীর্ণ (২ বছর+) কাঁচামাল (BDT)", "মেয়াদোত্তীর্ণ কাঁচামাল"],
];
...
function render(j) {
  ...
  const tables = [
    ...
    ["মেয়াদোত্তীর্ণ কাঁচামাল (দাবি ৬)", rec.overstay, [
      ["serial", "#"], ["hs_code", "HS"], ["item_name", "পণ্য"], ["bill_numbers", "বিল"],
      ["into_bond_dates", "ইন্টু-বন্ড তারিখ"], ["overstay_quantity_kg", "অবশিষ্ট (কেজি)", 1],
      ["cutoff_date", "কর্তন-তারিখ"], ["total_revenue_impact", "দাবি (৳)", 2],
    ]],
