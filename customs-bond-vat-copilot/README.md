...
"🧮 সংখ্যাগত যাচাই" ট্যাবে নিরীক্ষক সংখ্যা বসালে টুল স্বয়ংক্রিয়ভাবে ঘাটতি ও সম্ভাব্য রাজস্ব হিসাব করে। বন্ড (non-garments) মডিউলে এখন ৭টি check (checklist-এর ৯টির মধ্যে ৭টিই সংখ্যায় auto-check হয়):

| Check | কী হিসাব হয় | আইন |
|-------|-------------|-----|
| Entitlement অতিক্রম | আমদানি − অনুমোদিত entitlement; অতিরিক্ত × শুল্ক-কর | BWL Rules |
| B/E vs রেজিস্টার | Bill of Entry আমদানি − রেজিস্টারে লিপিবদ্ধ; কম রেকর্ড × শুল্ক-কর | BWL Rules |
| Coefficient অতিরিক্ত ব্যবহার | প্রকৃত ব্যবহার − (উৎপাদন × coefficient) | BWL Rules |
| UD vs রপ্তানি | UD দাবিকৃত ব্যবহার − রপ্তানি-সমর্থিত ব্যবহার | Customs Act §21 |
