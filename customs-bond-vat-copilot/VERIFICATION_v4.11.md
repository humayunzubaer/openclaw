...
1. **C1 — মেয়াদোত্তর আমদানি** (Case-B ৩৬৮ মে.টন → ~৳৩৫ লক্ষ; স্পষ্ট স্পেক)
2. **C3 — বন্ড লাইসেন্স ক্যাপাসিটি উৎস** (Case-B ৩,৪০০ মে.টন; ছোট, নির্দিষ্ট)
...
- **যাচাই:** `tests/test_post_period_c1.py` — ৩ কেস, ১৬টি assertion, সব pass
  (Case-B প্যাটার্ন: মেয়াদোত্তর import → পৃথক দাবি; regression: in-period
  দাবি ১/২ অক্ষত)।
...
- **উৎস অগ্রাধিকার:** (১) বন্ড লাইসেন্সের ধারণক্ষমতা → (২) প্রদত্ত মান →
  ...
  থাকিলেও তাহাই চূড়ান্ত (নিরীক্ষক নির্দেশ; Case-B ৩,৪০০ মে.টন)।
...
- **যাচাই:** `tests/test_extended_entitlement_c2.py` — ৩ কেস (Case-B combined
