...
/// আর ব্যবহারকারী চাইলে batch চলাকালীনও লাইব্রেরিতে ঘুরতে পারেন।
class OcrQueue {
  ...
  Future<void> runDocument(
    ...
    // hasImage গার্ড: import করা (Word/Excel) পাতায় ছবি থাকে না, OCR প্রযোজ্য নয়
    // (এগুলো আগে থেকেই ocrDone:true থাকে, তবু ভবিষ্যতের নিরাপত্তার জন্য চেক)।
    final pending = document.pages.where((p) => !p.ocrDone && p.hasImage).toList();
